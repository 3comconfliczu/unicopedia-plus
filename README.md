...
- This feature deals with the 4,022 emoji defined in the **Emoji 12.1** version of the [emoji-test.txt](https://www.unicode.org/Public/emoji/12.1/emoji-test.txt) data file.
- The 9 *component* (5 *skin-tone* and 4 *hair-style*) emoji and the 3,178 *fully-qualified* (**RGI**) emoji are presented in a standard way, while the 835 *non-fully-qualified* emoji are shown in a distinctive muted (grayed out) style.
...
- The groups and subgroups of emoji are those defined in the **Emoji 12.1** version of the [emoji-test.txt](https://www.unicode.org/Public/emoji/12.1/emoji-test.txt) data file.
- Only the 9 *component* emoji and the 3,178 *fully-qualified* (**RGI**) forms of the emoji are used unless they cannot be displayed properly, depending on the emoji support level of the operating system.
